...
namespace ConsoleApplication1.TestCases
{
    class TTBO
    {
        ...
        public static void FindWager(string BetNo)
        {
            ...
            ElementVerify.Exist(driver, By.Id("txtDateFrom"));

            //Click on calendar icon
            driver.FindElement(By.Id("txtDateFrom")).ClickOnIt("Event Date From");

            //Find the calendar
            ElementVerify.Exist(driver, By.Id("ui-datepicker-div"));
            ...
            //Wager No Textbox
            ElementVerify.Exist(driver, By.Id("txtWagerNo"));
            ...
            foreach (string wager in wagers)
            {
                ...
                ElementVerify.Exist(driver, By.ClassName("acct-no"));
